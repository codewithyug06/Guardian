...
from .agents import (
    ...
    visa_enforcement_agent, coder_agent, prophet_agent, ghost_agent
)
...
def build_compliance_graph():
    ...
    workflow.add_node("ghost", ghost_agent) # NEW RED TEAM NODE
    ...
    workflow.add_conditional_edges(
        ...
        {
            "retry": "scout",
            "continue": "ghost" # Scout now passes to Ghost Agent
        }
    )
    
    workflow.add_edge("ghost", "sentry") # Ghost passes to Sentry
    workflow.add_edge("sentry", "architect")
    workflow.add_edge("architect", "coder")
    workflow.add_edge("coder", "prophet")
